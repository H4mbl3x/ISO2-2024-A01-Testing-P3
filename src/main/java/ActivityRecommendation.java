public class ActivityRecommendation {
    ...
    public static String recommendActivity(Weather weather, HealthStatus healthStatus, SpaceConstraint spaceConstraint) {
        ...
        } else if (weather.getTemperature() <= 35 && !weather.isPrecipitation()) {
